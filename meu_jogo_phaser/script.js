...
class GameScene2 extends Phaser.Scene {
    ...
    create() {
        ...
        for (let i = 0; i < 5; i++) {  // Altere o número para gerar mais inimigos
...
class GameSuccessScene extends Phaser.Scene {
    constructor() {
        super("GameSuccessScene");
    }

    preload() {
        this.load.image('backgroundGameSuccess', 'assets/background_game_success.png');
    }

    create() {
        this.add.image(400, 300, 'backgroundGameSuccess');
